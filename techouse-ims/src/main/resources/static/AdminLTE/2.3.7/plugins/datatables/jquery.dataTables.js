document.write("<script language=javascript src='/AdminLTE/2.3.7/plugins/datatables/i18n/datatables.i18n.js'></script>");
/*! DataTables 1.10.7
...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			if(DefaultLanguage)
			{
				_fnLanguageCompat( DefaultLanguage );
			}
			else if ( oInit.oLanguage )
			{
	...
	DataTable.ext = _ext = {
		...
		/**
		 * <code>$.fn.dataTable.ext.errMode = 'throw';</code>
		 * Error reporting.
		 * 
